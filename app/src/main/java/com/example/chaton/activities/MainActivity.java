...
import com.example.chaton.adapters.RecentConversationsAdapter;
import com.example.chaton.databinding.ActivityMainBinding;
import com.example.chaton.listeners.ConversionListener;
import com.example.chaton.models.ChatMessage;
...
public class MainActivity extends AppCompatActivity implements ConversionListener {
    ...
    private void loadUserDetails(){
        ...
        byte[] bytes = Base64.decode(preferenceManager.getString(Constants.KEY_NAME), Base64.DEFAULT);
